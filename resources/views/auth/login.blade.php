...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            min-height: 100vh;
            padding: 2rem 0; /* Padding konsisten dengan halaman register */
        }
        .card-login {
            border: none;
            border-radius: 15px;
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card card-login">
                    ...
                    <div class="card-header bg-mis-navy text-center py-4">
                        ...
                        <div class="logo-placeholder mb-1">MIS Portal</div>
                        <p class="mb-0 small text-light opacity-75">Masukkan kredensial Anda untuk masuk</p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required autofocus placeholder="contoh@domain.com">
                                </div>
                                @error('email')
